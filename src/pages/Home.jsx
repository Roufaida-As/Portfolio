                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-20 gap-8 lg:gap-16">
                        ...
                        <div className={`w-full lg:w-1/2 mt-12 lg:mt-0 flex justify-center transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
                            ...
                            <div className="relative w-full h-64 sm:h-80 lg:h-[500px] flex items-center justify-center">
                                ...
                                <div className={`absolute w-70 h-70 sm:w-90 sm:h-90 lg:w-105 lg:h-105 rounded-full border-4 animate-spin-slow ${darkMode ? 'border-purple-400/30' : 'border-purple-600/30'
                                    }`} style={{ animationDuration: '20s' }}>
                                </div>

                                {/* Secondary circle - Responsive sizing */}
                                <div className={`absolute w-60 h-60 sm:w-82 sm:h-82 lg:w-90 lg:h-90 rounded-full border-2 animate-spin-slow ${darkMode ? 'border-pink-400/20' : 'border-pink-600/20'
                                    }`} style={{ animationDuration: '15s', animationDirection: 'reverse' }}>
                                </div>

                                {/* Main image container - Responsive sizing */}
                                <div className={`w-52 h-52 sm:w-74 sm:h-74 lg:w-80 lg:h-80 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 shadow-2xl flex items-center justify-center ${darkMode ? 'shadow-purple-500/50' : 'shadow-purple-500/30'
                                    }`}>
                                    <div className="w-48 h-48 sm:w-70 sm:h-70 lg:w-76 lg:h-76 rounded-full bg-gradient-to-br from-white to-purple-100 overflow-hidden flex items-center justify-center">
                                        <img
